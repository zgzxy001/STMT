...
@output:
    ...
    path_to_blender --background --python blender_process.py obj_path 5000 resized_obj_path
    For example:
    /home/xiaoyu/tm_cnn/data/amass/src/blender/blender/blender --background --python blender_process.py 0.obj 5000 0_resized.obj
...
class Process:
    ...
    def simplify(self, mesh, target_faces):
        ...
        print('nfaces = ', nfaces) # nfaces = 13776
